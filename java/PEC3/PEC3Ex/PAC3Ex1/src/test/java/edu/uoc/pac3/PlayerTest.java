...
public class PlayerTest {
    ...
    void testCreatePlayer() {
        ...
        assertNull(player.getPet()); // este player no tiene pet por lo tanto se espera un null
        ...
        assertNotNull(player.getPet()); // este player tiene pet por lo tanto tiene que tener un objeto pet y no ser nulo
